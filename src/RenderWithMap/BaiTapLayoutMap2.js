...
export default class BaiTapLayoutMap2 extends Component {
    dataPhim = [
        {
            "maPhim": 1321,
            "tenPhim": "Ted2",
    ...
    renderFilm = () => {
        return this.dataPhim.map((film, index) => {
            return <div className="col-4">
                <div className="card text-left">
                    <div style={{ backgroundImage: `url('${film.hinhAnh}')`, backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundSize: "cover" }}>
                        <img style={{ opacity: '0', height: "300px" }} className="card-img-top" src="holder.js/100px180/" alt />
                    </div>
                    <div className="card-body">
                        <h4 className="card-title">
                            {film.tenPhim.length > 20 ? <span>{film.tenPhim.substr(0, 20)}...</span> : <spa>{film.tenPhim}</spa>}
                        </h4>
                        <p className="card-text">
                            {film.moTa.length > 100 ? <span>{film.moTa.substr(0, 100)}...</span> : <span>{film.moTa}</span>}
                        </p>
                    </div>
                </div>
